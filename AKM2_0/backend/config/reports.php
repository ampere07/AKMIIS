...
return [
    ...
    |
    */
    'brand' => env('REPORTS_BRAND', 'AKM FIBER'),
    ...
    */
    'mail' => [
        'from'      => env('REPORTS_MAIL_FROM', 'billing@akmiis.com'),
        'reply_to'  => env('REPORTS_MAIL_REPLY_TO', 'billing@akmiis.com'),
        'from_name' => env('REPORTS_MAIL_FROM_NAME', 'AKM Fiber Reports'),
    ],
