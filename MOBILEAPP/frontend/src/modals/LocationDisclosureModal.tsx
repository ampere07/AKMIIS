    ...
    const points = [
        ...
        },
        {
            ...
            body: 'Only so your dispatch team can see where you are on the live monitor, assign '
                + 'you to nearby job orders, and confirm site visits. It is sent to the AKM '
                    ...
                    {isBackgroundStage ? (
                        <>
                            ...
                            <Text style={styles.lead}>
                                ...
                                only while AKM is open on screen. Everything else in the app keeps
                                working either way.
                            </Text>
                        </>
                    ) : (
                        <>
                            ...
                            <Text style={styles.lead}>
                                AKM collects your <Text style={styles.strong}>precise location</Text>
